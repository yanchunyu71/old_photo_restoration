...
class UnPairOldPhotos_SR(BaseDataset):  ## Synthetic + Real Old
    ...
    def __getitem__(self, index):
        ...
        w,h=A.size
        if w<256 or h<256:
            A=ptransforms.Resize(256,Image.BICUBIC)(A)
...
class PairOldPhotos(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if w<256 or h<256:
            A=ptransforms.Resize(256,Image.BICUBIC)(A)
            B=ptransforms.Resize(256, Image.BICUBIC)(B)
...
class PairOldPhotos_with_hole(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt.isTrain:
            ...
            B=ptransforms.RandomCrop(256)(B)
            A=online_add_degradation_v2(B)
            ### Remind: A is the input and B is corresponding GT
            ...
            #A=A.resize((256,256))
            A=ptransforms.CenterCrop(256)(A)
            B=A
        ...
        mask_tensor = ptransforms.ToTensor()(mask)
